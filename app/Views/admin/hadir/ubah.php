...
<form action="<?= base_url("admin/hadir/ubah") ?>" method="post" data-parsley-validate>
    <div class="row">
        <div class="col-lg-3">
            <div class="form-group">
                ...
                <input id="kode_acara" name="kode_acara" type="text" inputmode="numeric" class="form-control" placeholder="Masukkan kode acara (hanya angka)" maxlength="10" readonly data-parsley-required-message="Kode Acara wajib diisi!" value="<?= $data->kode_acara ?>">
            </div>
        </div>
        <div class="col-lg-9">
            <div class="form-group">
    ...
    <div class="row">
        <div class="col-lg-6">
            ...
            <label class="tx-italic tx-danger">2. Kode Acara tidak bisa diubah atau dihapus bila sudah ada yang mengisi kehadiran.</label>
        </div>
