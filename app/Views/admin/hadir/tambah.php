        ...
        <div class="col-lg-5">
            <div class="form-group">
                ...
                <select id="tipe" name="tipe" type="text" class="form-control" required data-parsley-required-message="Tipe Acara wajib diisi!">
                    <option value="0">0 - WAJIB diikuti fungsionaris (hanya pengurus)</option>
                    <option value="1" selected>1 - TIDAK WAJIB diikuti fungsionaris (dengan peserta umum)</option>
                    <option value="2">2 - Hanya diikuti FUNGSIONARIS tertentu (dengan peserta umum)</option>
                    <option value="3">3 - Hanya diikuti DEPARTEMEN tertentu (internal departemen)</option>
                </select>
            </div>
        </div>
    </div>
