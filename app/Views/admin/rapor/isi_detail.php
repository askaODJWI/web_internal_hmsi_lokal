            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-6">
                    <table class="table table-borderless table-sm">
                        ...
                        <tr>
                            <td class="align-middle"><label for="indikator3" class="tx-bold">Indikator 3 <span class="tx-danger">*</span></label></td>
                            <td><input id="indikator3a" name="indikator3a" type="number" value="<?= $data[$i+2]->nilai_a ?>" class="form-control form-control-sm" placeholder="Masukkan nilai" maxlength="3" required data-parsley-required-message="Bagian ini wajib diisi!"></td>
                            <td><input id="indikator3b" name="indikator3b" type="number" value="<?= $data[$i+2]->nilai_b ?>" class="form-control form-control-sm" placeholder="Masukkan nilai" maxlength="3" required data-parsley-required-message="Bagian ini wajib diisi!"></td>
                        </tr>
                    </table>
                </div>
